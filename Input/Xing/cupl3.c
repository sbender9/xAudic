/*____________________________________________________________________________
	...
	$Id: cupl3.c,v 1.1.1.1 2001/05/21 18:46:55 sbender Exp $
____________________________________________________________________________*/
...
/* at entry bit getter points at id, sync skipped by caller */
   ...
   if ( last_br_index != -1 && last_br_index != br_index )
     xbitrate_changed(mp_br_tableL3[m->cupl.id][br_index]);
   else
     last_br_index = br_index;
